...
from CondFoleyGen.specvqgan.modules.losses.vggishish.model import VGGishish
from CondFoleyGen.specvqgan.utils import get_ckpt_path
...
class LPAPS(nn.Module):
    ...
    def load_from_pretrained(self, name="vggishish_lpaps"):
        print("Loading pretrained LPAPS loss")
        ckpt = get_ckpt_path(name, "CondFoleyGen/specvqgan/modules/autoencoder/lpaps")
...
class ScalingLayer(nn.Module):
    def __init__(self):
        ...
        stat_path = get_ckpt_path('vggishish_mean_std_melspec_10s_22050hz', 'CondFoleyGen/specvqgan/modules/autoencoder/lpaps')
...
class vggishish16(torch.nn.Module):
    ...
    def vggishish16(self, pretrained: bool = True) -> VGGishish:
        ...
        if pretrained:
            ckpt_path = get_ckpt_path('vggishish_lpaps', "CondFoleyGen/specvqgan/modules/autoencoder/lpaps")
